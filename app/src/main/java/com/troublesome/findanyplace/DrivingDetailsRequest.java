 ...
 */
public class DrivingDetailsRequest {

    //Tag used to cancel the request
    public static String tag_json_obj = "json_obj_req";
    static final String directionURL = "https://maps.googleapis.com/maps/api/directions/json?key=AIzaSyAwJMcBAzDt2ij8YKUKLgtZJKIZVOJpbAA";
    static final String origin = "&origin=";
    static final String destination = "&destination=";
    static String distance, duration;

    public static void getDrivingDetailsRequest(Location location) {
    ...
    private static void populatingView() {
        DetailsActivity.carDurationTextView.setText(duration);
        DetailsActivity.carDistanceTextView.setText(distance);
    }
}
